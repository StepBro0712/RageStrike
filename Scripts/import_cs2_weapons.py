...
WEAPONS = [
    ("AK47",   r"rifle-ak-47-weapon-model-cs2\source\AK47.glb"),
    ("USPS",   r"pistol-usp-s-weapon-model-cs2\source\USPS.glb"),
    ("Deagle", r"deagle-counter-strike-2\source\unpacked\Deagle\Deagle_CS2.fbx"),
    ("M4A4",   r"m4a4-counter-strike-2\source\unpacked\M4A4\M4A4_CS2.fbx"),
    ("M4A1S",  r"m4a1s-counter-strike-2\source\unpacked\M4A1S\M4A1S_CS2.fbx"),
    ("AUG",    r"aug-counter-strike-2\source\unpacked\AUG\AUG_CS2.fbx"),
    ("Famas",  r"famas-counter-strike-2\source\unpacked\Famas\Famas_CS2.fbx"),
    ("Galil",  r"galil-ar-counter-strike-2\source\unpacked\GalilAr\GalilAr_CS2.fbx"),
    ("MP7",    r"mp7-counter-strike-2\source\unpacked\MP7\MP7_CS2.fbx"),
    ("M249",   r"m249-counter-strike-2\source\unpacked\M249\M249_CS2.fbx"),
    ("Negev",  r"negev-counter-strike-2\source\unpacked\Negev\Negev_CS2.fbx"),
    ("MP9",    r"mp9\source\unpacked\MP9.obj"),
    ("AWP",    r"awp\source\unpacked\AWP.obj"),
    ("Bizon",  r"bizon\source\unpacked\bizon.obj"),
    ("C4",     r"bomb-c4-explosive-model-cs2\source\C4.glb"),
    ("Armor",  r"armor-armor-and-helmet-model-cs2\source\ARMORandHELMET.glb"),
]
